...
;(function($) {
	...
	$(function() {
	    $('.contact-em').attr('href', $.rotate13('znvygb:gvttrevmml@tznvy.pbz')).text('email');
	    });

	$(function() {
	    $('.contact-full').attr('href', $.rotate13('znvygb:gvttrevmml@tznvy.pbz')).text(
	        $.rotate13('gvttrevmml@tznvy.pbz'));
	    });
